...
//     //Legion Masteries
//     set researchSet = IncompatibleResearchSet.create()
//     call researchSet.add('R04G')   //Nathrezim Elitism Mastery
//     call researchSet.add('R061')   //Demonic Power mastery
...
//     //Lordaeron Masteries
//     set researchSet = IncompatibleResearchSet.create()
//     call researchSet.add('R04A')    //Composite Weapons
...
//     call researchSet.add('R042')    //Huntress Mastery
