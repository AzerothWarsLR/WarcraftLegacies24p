library FrostwolfQuestSetup requires FrostwolfSetup, WarsongSetup, QuestDrektharsSpellbook, QuestFreeNerzhul, QuestGazlowe, QuestSeaWitch, QuestThunderBluff, QuestScepterOfTheQueen, QuestZeppelins
  ...
  public function OnInit takes nothing returns nothing
    ...
    call FACTION_FROSTWOLF.AddQuest(QuestMammoth.create())
    call FACTION_FROSTWOLF.AddQuest(QuestHighmountain.create())
    call FACTION_FROSTWOLF.AddQuest(QuestRagetotem.create())
    call FACTION_FROSTWOLF.AddQuest(QuestWorldShaman.create())
    //Misc
