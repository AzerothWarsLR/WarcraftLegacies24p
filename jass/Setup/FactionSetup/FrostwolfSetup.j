library FrostwolfSetup requires Faction, TeamSetup 
  ...
  public function OnInit takes nothing returns nothing 
    ...
    call f.ModObjectLimit('o065', UNLIMITED) //Shipyard   

    call f.ModObjectLimit('opeo', UNLIMITED) //Peon   
    call f.ModObjectLimit('h0AN', 2) //Peon   
    call f.ModObjectLimit('h0AM', 4) //Peon   
    call f.ModObjectLimit('o063', 6) //Peon   
    call f.ModObjectLimit('n0DH', 4) //Peon   
