library Faction initializer OnInit requires Persons, Event, Set, QuestData, Environment, UnitType
  ...
  private method distributeGates takes nothing returns nothing
      ...
      loop
          ...
          if loopUnitType != 0 and loopUnitType.IsGate then
              if this.Team.PlayerCount > 1 then
...
endmethod
  ...
  endmethod
    ...
    //This should get used any time a player exits the game without being Absence; IE they left, went afk, became an observer, or triggered an event that causes this
