library LegendNeutral initializer OnInit requires Legend 
  ...
  globals 
    ...
    Legend LEGEND_BLACKROOK 
    Legend LEGEND_SHALADRASSIL    
  endglobals 
  ...
  private function OnInit takes nothing returns nothing 
    ...
    set LEGEND_BLACKROOK = Legend.create("") 
    set LEGEND_BLACKROOK.Unit = gg_unit_h0AL_0900 
    set LEGEND_BLACKROOK.Capturable = true 

    set LEGEND_SHALADRASSIL = Legend.create("") 
    set LEGEND_SHALADRASSIL.Unit = gg_unit_e01W_0919
    set LEGEND_SHALADRASSIL.Capturable = true 
  endfunction 
